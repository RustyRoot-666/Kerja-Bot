...
from handlers.web_auth import build_web_auth_handlers
...
async def post_init(application: Application) -> None:
    ...
    if application.job_queue is None:
        logging.warning("JobQueue unavailable; scheduled jobs disabled. Install python-telegram-bot[job-queue].")
    else:
...
def build_application() -> Application:
    ...
    for handler in build_web_auth_handlers():
