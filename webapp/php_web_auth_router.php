...
if($path==='/api/auth/me'&&$method==='GET'){$tech=auth_current();if(!$tech)web_auth_respond(['ok'=>false,'error'=>'unauthorized'],401);web_auth_respond(['ok'=>true,'technician'=>['id'=>(int)$tech['id'],'telegram_id'=>(int)$tech['telegram_id'],'nik'=>$tech['nik'],'name'=>$tech['name'],'sto'=>$tech['sto'],'role'=>$tech['role']]]);}
