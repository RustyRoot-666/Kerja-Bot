...
#activeTechBtn{margin-left:auto;margin-right:8px}
.active-tech-overlay{position:fixed;inset:0;z-index:5000;background:rgba(2,5,9,.94);backdrop-filter:blur(10px);display:flex;align-items:stretch;justify-content:center;padding:18px}
.active-tech-panel{width:min(1180px,100%);display:flex;flex-direction:column;border:1px solid #26384a;background:#071019;box-shadow:0 24px 80px rgba(0,0,0,.55);border-radius:18px;overflow:hidden}
.active-tech-head{display:flex;align-items:center;gap:14px;padding:14px 18px;border-bottom:1px solid #1d2b38}.active-tech-head h2{margin:0;font-size:20px}.active-tech-head small{color:#7890a7}.active-tech-close{margin-left:auto}.active-tech-body{display:grid;grid-template-columns:1fr 300px;min-height:0;flex:1}.active-tech-map{min-height:560px;background:#0a1118}.active-tech-list{overflow:auto;padding:12px;border-left:1px solid #1d2b38}.active-tech-card{padding:12px;border:1px solid #1d2b38;border-radius:12px;margin-bottom:9px;background:#0a151f}.active-tech-card b{display:block}.active-tech-card small{display:block;color:#7e94a9;margin-top:4px}.active-tech-card.online{border-color:#1f7056}.active-tech-card.idle{border-color:#806522}.tech-status{display:inline-block;margin-top:8px;font-size:9px;padding:4px 7px;border-radius:99px;border:1px solid #31506a}.leaflet-popup-content-wrapper,.leaflet-popup-tip{background:#071019;color:#e8f4ff}.leaflet-popup-content{margin:12px}.tech-popup strong{font-size:14px}.tech-popup small{display:block;color:#8ba1b6;margin-top:4px}.tech-marker{width:16px;height:16px;border-radius:50%;border:3px solid #071019;box-shadow:0 0 0 2px #56e0ff,0 0 16px rgba(86,224,255,.65);background:#56e0ff}.tech-marker.idle{box-shadow:0 0 0 2px #ffc857,0 0 14px rgba(255,200,87,.5);background:#ffc857}.tech-marker.offline{box-shadow:0 0 0 2px #7d8b98;background:#7d8b98}
@media(max-width:800px){.active-tech-body{grid-template-columns:1fr}.active-tech-list{max-height:260px;border-left:0;border-top:1px solid #1d2b38}.active-tech-map{min-height:430px}}
